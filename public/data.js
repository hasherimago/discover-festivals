export const FESTIVALS = [
  ...
  },
  {
    ...
    quote: null,
    editorial: {
      about: "One stage, deliberately limited capacity, and a 30-hour marathon closing the final day. Rooted in techno's forward momentum, Basilar is built around a single stage by design — a choice that preserves flow, tension and narrative across 60+ hours of music.  Past editions attracted 70% foreign audiences from across Europe, Asia and the Americas. 2026 lineup: Afra, Anika Kunst, Decka, DJ Red, Enkō, Fadi Mohem, Luisa, ROD and more.",
      vibe: "Artists are given the space to unfold extended, free-flowing sets, trusting the crowd and the moment. The result is not a sequence of performances but a shared journey.  Barragem da Queimadela — a dam lake in the green hills of northern Portugal — is not backdrop but active presence.",
      sounds: "Deep, meticulous techno — dub techno, raw hypnotic, mental and exploratory. Past artists include DVS1, Ben Klock, Oscar Mulero, Haruka, KR!Z, Blasha & Allatt, Freddy K and XDB. Consistency of vision over edition-to-edition variety.",
      doNotMiss: "The 30-hour final day marathon — a defining ritual where time dissolves and the dancefloor becomes a sustained act of connection.  The most Basilar moment Basilar offers.",
      tip: "Fafe is about 50 minutes from Porto by car. The dam lake setting means temperatures drop sharply after dark — bring a layer even in September. Camping on site.",
    },
